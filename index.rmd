...
``` {r fig2, echo = F, message = F, results = "asis", error=F, fig.height=4}
...
``` {r fig3, echo = F, message = F, results = "asis", error=F, fig.height=4}
...
``` {r fig4, echo = F, message = F, results = "asis", error=F, fig.height=4}
