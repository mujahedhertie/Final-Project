...
```{r bar, echo=F, warning=F, message=F, error=F, results='asis', fig.width=13}
barplot <- ggplot(Data) +
...
``` {r fig1, echo = F, message = F, results = "asis", error=F, fig.height=4}
...
``` {r fig5, echo = F, message = F, results = "asis", error=F, fig.height=4}
...
``` {r fig6, echo = F, message = F, results = "asis", error=F, fig.height=4}
