...
subtitle: An analysis of the March 2016 state elections Germany
bibliography:
- Library.bib
- Packages1.bib
- Packages2.bib
...
stargazer(correlation.matrix,
          title= 'Correlation matrix of all the variables',
          font.size = 'tiny',
...
## The corelation of GDP per capita and AfD vote share
...
## The corelation of unemployment and AfD vote share
...
## The corelation of no. of refugees and AfD vote share
...
stargazer::stargazer(reg1, reg2, reg3, reg4,
                     ...
                     type="latex", header = F, 
                     no.space=TRUE) # add no.space=TRUE to remove space in betwen line. 
```

## Future research

- Analysis of all state elections in Germany where the AfD is present in order to have more observations
